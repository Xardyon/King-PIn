...
/////// Diffuse:
                ...
                float3 diffuseColor = lerp(lerp(lerp((_ReflectionTex_var.rgb*0.8),_MainTex_var.rgb,0.1),_MainTex_var.rgb,saturate(pow((i.vertexColor.r+(i.vertexColor.r*_HeightTex_var.rgb)),1.0))),(_MainTex_var.rgb*0.2),i.vertexColor.g);
