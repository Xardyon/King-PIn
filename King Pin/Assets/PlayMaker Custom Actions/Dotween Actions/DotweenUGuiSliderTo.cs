...
namespace HutongGames.PlayMaker.Actions
{
		...
		public string descriptionArea = "BETA - Minimum Dotween version requirement: v1.0.665";
		...
		public override void Reset ()
		{
			...
			case loopType.None:
				if (settingLoops.Value > 0 || settingLoops.Value < 0) Debug.LogWarning ("!!! Loop Time is set but no 'Loop Type' is selected !!! ");
				break;
