...
namespace HutongGames.PlayMaker.Actions
{
		...
		public override void Reset ()
		{
			...
			if (scrambleTypeSelect != scrambleType.None && scrambleChars.Value.Length > 0 && scrambleChars.Value.Length <10) Debug.LogWarning ("!!!  Use as many characters as possible (minimum 10) in 'Scramble Chars' because DOTween uses a fast scramble mode which gives better results with more characters. !!! ");
